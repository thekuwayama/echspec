...
TLS Encrypted Client Hello Server
        ...
        ✔ Clients SHOULD ignore any ECHConfig structure with a public_name that is not a valid host name in preferred name syntax. [6.1.7-5]
        ✔ Clients SHOULD ignore the structure if the final LDH label may be interpreted as IPv4 literals. [6.1.7-5]
